...
class About(Screen):
	...
	def populate(self):
		...
		if getMachineBuild() in ('vusolo4k','vuzero4k','vuultimo4k'):
			...
			cpuMHz = "   (1,3 GHz)"
	        elif getMachineBuild() in ('u51','u5','u53','u52','u5pvr','h9','h9combo','sf8008','i55plus'):
			cpuMHz = "   (1,6 GHz)"
		...
		if getMachineBuild() not in ('osmio4k','h9','h9combo','vuzero4k','sf5008','et13000','et1x000','hd51','hd52','vusolo4k','vuuno4k','vuuno4kse','vuultimo4k','sf4008','dm820','dm7080','dm900','dm920', 'gb7252', 'dags7252', 'vs1500','h7','xc7439','8100s','u5','u5pvr','u52','u53','u51','sf8008','i55plus'):
