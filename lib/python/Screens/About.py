...
class About(Screen):
	...
	def populate(self):
		...
		if path.exists('/boot/bootname'):
			...
			f.close()
		if getMachineBuild() in ('cc1','sf8008','sf8008s'):
		...
		if getMachineBuild() not in ('vuduo4k','osmio4k','h9','h9combo','vuzero4k','sf5008','et13000','et1x000','hd51','hd52','vusolo4k','vuuno4k','vuuno4kse','vuultimo4k','sf4008','dm820','dm7080','dm900','dm920', 'gb7252', 'dags7252', 'vs1500','h7','xc7439','8100s','u5','u5pvr','u52','u53','u54','u51','sf8008','i55plus','sf8008s'):
