...
def getHotkeys():
	...
	(_("Red"), "red", "Plugins/Extensions/EPGSearch/1"),
        (_("Red long"), "red_long", ""),
        (_("Green"), "green", "Infobar/showPluginBrowser"),
        (_("Green long"), "green_long", "Infobar/subtitleSelection"),
        (_("Yellow"), "yellow", "Infobar/activateYellowButton"),
        (_("Yellow long"), "yellow_long", "Module/Screens.Hotkey/HotkeySetup"),
