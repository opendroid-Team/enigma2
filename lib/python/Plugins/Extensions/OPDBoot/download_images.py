...
class DownloadOnLineImage(Screen):
	...
	BRANDOEM = getBrandOEM()
        ...
        if boxname in ('gb800seplus', 'gbquadplus', 'gbquad4k', 'gbue4k', 'gbultraue', 'gbx1', 'gbx2', 'gbx3'):
            ...
            BRANDOEMDROID = 'VU+'
        elif boxname in ('zgemmahs', 'zgemmah2s', 'zgemmah2splus', 'zgemmah2h', 'zgemmah3ac', 'zgemmah32tc', 'zgemmah5', 'optimussos3plus', 'zgemmah52s', 'zgemmah52splus', 'zgemmah5ac', 'ozgemmah52tc', 'zgemmah6', 'zgemmah7', 'zgemmah9s', 'zgemmah9t', 'zgemmai55'):
