...
imagesCounter = 0
images.append(["OPD 6.7", "http://images.opendroid.org/6.7"])
...
class FlashOnline(Screen):
	...
	def read_current_multiboot(self):
		...
		elif getMachineBuild() in ("cc1","sf8008","sf8008s"):
			if self.list[self.selection] == "Recovery":
	...
	def list_files(self, PATH):
		...
		if SystemInfo["HaveMultiBoot"]:
			path = PATH
			if getMachineBuild() in ("hd51","vs1500","h7","8100s","gb7252","cc1","sf8008","osmio4k","sf8008s"):
	...
	def Start_Flashing(self):
		...
		if os.path.exists(ofgwritePath):
			...
			if self.simulate:
				...
				elif getMachineBuild() in ("h9combo","u51","u52","u53","u54","u5","u5pvr","cc1","sf8008","sf8008s"):
