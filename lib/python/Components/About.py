...
def getCPUSpeedString():
	if getMachineBuild() in ('vusolo4k','vuultimo4k', 'vuzero4k'):
		...
		return "1,3 GHz"
	elif getMachineBuild() in ('u51','u52','u53','u54','u5','u5pvr','h9','h9combo','sf8008','i55plus','sf8008s'):
		return "1,6 GHz"
		...
		for x in lines:
			...
			if len(splitted) > 1:
				...
				if splitted[0].startswith("processor"):
					if getMachineBuild() in ('u51','u52','u53','u54','vuultimo4k','u5','u5pvr','h9','h9combo','sf8008','i55plus','vuduo4k'):
						cores = 4
