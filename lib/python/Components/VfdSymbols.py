...
def SymbolsCheck(session, **kwargs):
		...
		if getBoxType() in ('osnino','osninoplus','mbmicrov2','revo4k','force3uhd', 'ixussone', 'ixusszero', 'mbmicro', 'e4hd', 'e4hdhybrid', 'dm7020hd', 'dm7020hdv2', '9910lx', '9911lx') or getMachineBuild() in ('dags7362' , 'dags73625', 'dags5'):
			POLLTIME = 1
...
class SymbolsCheckPoller:
	...
	def Recording(self):
		...
		elif getBoxType() in ('ixussone', 'ixusszero', 'osnino', 'osninoplus'):
			recordings = len(NavigationInstance.instance.getRecordings(False,Components.RecordingConfig.recType(config.recording.show_rec_symbol_for_rec_types.getValue())))
